webpackJsonp([0,1,2,3,4,5,6,7],Array(31).concat([
/* 31 */
...
var update = __webpack_require__(30)("8eb92ba8", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("a9e457dc", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("1bbe3f77", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("7eb2c709", content, true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__package_json__ = __webpack_require__(5);
...
var SETTINGS_KEY = __WEBPACK_IMPORTED_MODULE_2__package_json__["name"] + '-settings';
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.opts = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(this.opts, __WEBPACK_IMPORTED_MODULE_1_quasar__["b" /* LocalStorage */].get.item(SETTINGS_KEY));
    this.emitChanges();
  },
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("67725b2a", content, true);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quasar__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_SaveStatus__ = __webpack_require__(31);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("299a8ac6", content, true);
...
// module
exports.push([module.i, ".medium-editor-toolbar{top:0!important;width:100%;margin:0;border-radius:0}.medium-editor-toolbar li button.medium-editor-action{color:#e1e2e3;background-color:transparent}.medium-editor-toolbar li button.medium-editor-action:hover{color:#f2c037;background-color:#333}.medium-editor-toolbar li button.medium-editor-action.medium-editor-button-active{color:#d84747}.medium-editor-toolbar li button.medium-editor-action.medium-editor-button-first,.medium-editor-toolbar li button.medium-editor-action.medium-editor-button-last{border-radius:0;padding-left:12px;padding-right:12px;margin:0}@media screen and (min-width:767px){.medium-editor-toolbar{top:12px!important;width:auto;border-radius:20px}.medium-editor-toolbar li button.medium-editor-action.medium-editor-button-first{margin-left:20px}.medium-editor-toolbar li button.medium-editor-action.medium-editor-button-last{margin-right:20px}}#writer .layout-aside,#writer .layout-header{box-shadow:none!important;border-color:#e1e2e3}#writer .layout-header{border-bottom:none}#writer .layout-aside{border-right-width:1px;border-right-style:solid}@media print{#writer .layout-aside,#writer .layout-backdrop,#writer .layout-header{display:none}#writer .layout-page,#writer .layout-page-container{display:inline;width:100%!important;max-width:100%!important;padding:0!important;margin:0!important;overflow:visible}}#editor{display:block;box-sizing:border-box;min-width:256px;width:100%;max-width:640px;min-height:5rem;margin:0 auto;padding:1rem 2rem;outline:none;border:none;color:#111;font-family:LibreBaskerville,serif!important}#editor,#editor p,#editor pre,#editor table{line-height:2}#editor p+h1,#editor pre+h1,#editor table+h1{margin-top:5.656rem}#editor p+h2,#editor p+h3,#editor p+h4,#editor pre+h2,#editor pre+h3,#editor pre+h4,#editor table+h2,#editor table+h3,#editor table+h4{margin-top:2.828rem}#editor h1,#editor h2,#editor h3,#editor h4{margin:0 0 1.414rem;font-weight:inherit;line-height:1.2;color:#888}#editor h1{font-size:2.369em;color:#000}#editor h1+p{margin-top:2.828rem}#editor h2{font-size:1.777em}#editor h3{font-size:1.333em}#editor h4{font-size:1em}#editor table{width:100%;margin-bottom:1rem;border-collapse:collapse}#editor table thead{text-align:left}#editor table td,#editor table th{padding:.5rem;border-bottom:1px solid #e1e2e3;vertical-align:top}#editor table thead td,#editor table thead th{border-color:#888}@media screen and (max-width:575px){#editor table tr{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}#editor table td,#editor table th{min-width:100%}#editor table td:not(:last-of-type),#editor table th:not(:last-of-type){border-bottom:none}}#editor pre{padding:1rem;border-radius:.25rem;overflow-x:auto;background-color:#e1e2e3}#editor pre code{background-color:transparent;white-space:pre-wrap}#editor code{padding:.25rem;white-space:nowrap;background-color:#e1e2e3}#editor blockquote{border-left-color:#e1e2e3;line-height:1.5}#editor blockquote :last-child{margin-bottom:0}#editor hr{display:block;width:100%;border:none;border-top:1px solid #e1e2e3;margin:2rem 0 2.5rem}#editor:not(.parSpaceBetween) p{margin-bottom:0}#editor.parIdentFirstLine p{text-indent:2rem}@media screen and (min-width:767px){#editor{padding-top:0}}@media print{#editor{display:inline;padding:0}#editor h1:not(:first-child),#editor hr{page-break-before:always}#editor hr{display:block;margin:0;padding:0;border:none;visibility:hidden}#editor h1,#editor h2,#editor h3,#editor h4,#editor h5,#editor h6{page-break-after:avoid}#editor p+h1,#editor pre+h1,#editor table+h1{margin-top:0}#editor blockquote,#editor figure,#editor table{width:100%;page-break-inside:avoid}}", ""]);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quasar__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_medium_editor__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_medium_editor_autolist__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_medium_editor_autolist___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_medium_editor_autolist__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_medium_editor_autohr__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_medium_editor_autohr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_medium_editor_autohr__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_medium_editor_autoanglequotes__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_medium_editor_autoanglequotes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_medium_editor_autoanglequotes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_showdown__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_to_markdown__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_to_markdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_to_markdown__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_file_saver__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_screenfull__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_screenfull___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_screenfull__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_components_Toolbar__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_components_Toolbar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_components_Toolbar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_components_LeftMenu__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_components_LeftMenu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_components_LeftMenu__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_components_SaveAsModal__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_components_SaveAsModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_components_SaveAsModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_components_ExportModal__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_components_ExportModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_components_ExportModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_components_SettingsModal__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_components_SettingsModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_components_SettingsModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_components_AboutModal__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_components_AboutModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14_components_AboutModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__package_json__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__package_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__package_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_font_awesome_css_font_awesome_min_css__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_medium_editor_dist_css_medium_editor_min_css__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_medium_editor_dist_css_medium_editor_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17_medium_editor_dist_css_medium_editor_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_medium_editor_dist_css_themes_beagle_min_css__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_medium_editor_dist_css_themes_beagle_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_18_medium_editor_dist_css_themes_beagle_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_assets_fonts_LibreBaskerville_stylesheet_css__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_assets_fonts_LibreBaskerville_stylesheet_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_19_assets_fonts_LibreBaskerville_stylesheet_css__);
...
var PRODUCT_NAME = __WEBPACK_IMPORTED_MODULE_15__package_json__["productName"];
var CONTENT_BACKUP_KEY = __WEBPACK_IMPORTED_MODULE_15__package_json__["name"] + '-content-backup';
var CONTENT_LAST_SAVED_KEY = __WEBPACK_IMPORTED_MODULE_15__package_json__["name"] + '-content-last-saved';
var DEFAULT_CONTENT_HTML = '<h1>Welcome to «' + PRODUCT_NAME + '»</h1>' + '<p>When you feel <i>ready</i>, start to type your <b>masterpiece</b>...</p>';

var mdToHtmlConverter = new __WEBPACK_IMPORTED_MODULE_5_showdown___default.a.Converter({
...
var htmlToMdConverter = {
  convert: function convert(html) {
    return __WEBPACK_IMPORTED_MODULE_6_to_markdown___default()(html);
  }
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'writer',
  components: {
    QLayout: __WEBPACK_IMPORTED_MODULE_0_quasar__["k" /* QLayout */],
    VueMediumEditor: __WEBPACK_IMPORTED_MODULE_1_vue2_medium_editor___default.a,
    Toolbar: __WEBPACK_IMPORTED_MODULE_9_components_Toolbar___default.a,
    LeftMenu: __WEBPACK_IMPORTED_MODULE_10_components_LeftMenu___default.a,
    SaveAsModal: __WEBPACK_IMPORTED_MODULE_11_components_SaveAsModal___default.a,
    ExportModal: __WEBPACK_IMPORTED_MODULE_12_components_ExportModal___default.a,
    SettingsModal: __WEBPACK_IMPORTED_MODULE_13_components_SettingsModal___default.a,
    AboutModal: __WEBPACK_IMPORTED_MODULE_14_components_AboutModal___default.a
  },
  data: function data() {
    return {
      isElectron: this.$electron,
      ...
      meOptions: {
        ...
        autoLink: false,
        extensions: {
          autolist: new __WEBPACK_IMPORTED_MODULE_2_medium_editor_autolist___default.a(),
          autohr: new __WEBPACK_IMPORTED_MODULE_3_medium_editor_autohr___default.a(),
          autoangles: new __WEBPACK_IMPORTED_MODULE_4_medium_editor_autoanglequotes___default.a()
        },
        toolbar: {
          buttons: ['h1', 'h2', 'h3', 'subscript', 'superscript', 'bold', 'italic', 'underline', 'strikethrough', 'anchor', 'quote', 'pre', 'justifyLeft', 'justifyCenter', 'justifyRight', 'unorderedlist', 'orderedlist'],
          static: true,
          sticky: true
        }
      }
  ...
  computed: {
    ...
    isChanged: function isChanged() {
      return this.contentHTML !== __WEBPACK_IMPORTED_MODULE_0_quasar__["r" /* SessionStorage */].get.item(CONTENT_LAST_SAVED_KEY);
    },
    windowTitle: function windowTitle() {
      return (this.filename ? this.filename : 'No title') + (this.isChanged ? '*' : '') + ' - ' + PRODUCT_NAME;
    }
  },
  mounted: function mounted() {
    ...
    this.contentHTML = __WEBPACK_IMPORTED_MODULE_0_quasar__["b" /* LocalStorage */].get.item(CONTENT_BACKUP_KEY) || DEFAULT_CONTENT_HTML;
    __WEBPACK_IMPORTED_MODULE_0_quasar__["r" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, this.contentHTML);
  ...
  methods: {
    resetFile: function resetFile() {
      __WEBPACK_IMPORTED_MODULE_0_quasar__["r" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, DEFAULT_CONTENT_HTML);
      ...
      if (files && files.length > 0) {
        ...
        reader.onload = function (evt) {
          try {
            ...
            _this.filename = f.name.split('.')[0];
            _this.contentHTML = data.split('<body>')[1].replace('</body>', '').replace('</html>', '');

            __WEBPACK_IMPORTED_MODULE_0_quasar__["r" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, _this.contentHTML);
          } catch (err) {
            reader.onerror(err);
          }
        };
        reader.onerror = function (err) {
          console.error(err);
          _this.filename = null;
          _this.contentHTML = null;
        };
        reader.readAsText(f);
      }
    },
    importFile: function importFile(files) {
      var _this2 = this;
      ...
      if (files && files.length > 0) {
        ...
        reader.onload = function (evt) {
          try {
            var data = evt.target.result;
            _this2.filename = f.name.split('.')[0];

            if (f.type === 'text/markdown') {
              _this2.contentHTML = _this2.convertMdToHtml(data);
            } else if (f.type === 'text/plain') {
              _this2.contentHTML = _this2.convertTxtToHtml(data);
            }
          } catch (err) {
            reader.onerror(err);
          }
    ...
    saveFile: function saveFile(fn) {
      ...
      if (filename) {
        ...
        if (this.isElectron) {
          __webpack_require__(6).writeFile(filename, fileContent, function (err) {
            if (err) throw err;
          });
        } else {
          __WEBPACK_IMPORTED_MODULE_7_file_saver___default.a.saveAs(new Blob([fileContent], { type: 'text/html;charset=utf-8' }), filename);
        }
    ...
    saveFileAs: function saveFileAs() {
      var _this3 = this;
      ...
      if (this.isElectron) {
        this.$electron.remote.dialog.showSaveDialog({
          ...
          filters: [{ name: 'Plain HTML', extensions: ['html'] }]
        }, function (fn) {
          if (fn) {
            _this3.saveFile(fn);
          }
    ...
    exportFile: function exportFile(fn, ext) {
      ...
      if (fn) {
        ...
        if (fileType) {
          ...
          if (this.isElectron) {
            ...
            __WEBPACK_IMPORTED_MODULE_7_file_saver___default.a.saveAs(new Blob([fileContent], { type: fileType + ';charset=utf-8' }), filename);
          }
        }
      }
    },
    exportFileAs: function exportFileAs() {
      var _this4 = this;
      ...
      if (this.isElectron) {
        this.$electron.remote.dialog.showSaveDialog({
          ...
          if (fn) {
            ...
            _this4.exportFile(fnTokens[0], fnTokens[1]);
          }
        });
      } else {
    ...
    exit: function exit(evt) {
      ...
      if (this.$electron) {
        var closeFunc = function closeFunc() {
          ...
          _this5.$electron.remote.getCurrentWindow().close();
        };
    ...
    applySettings: function applySettings(opts) {
      this.opts = opts;
    },
    updateContentAndStats: function updateContentAndStats() {
      this.content = this.convertHtmlToTxt(this.contentHTML);

      if (this.content && this.content.length > 0) {
        __WEBPACK_IMPORTED_MODULE_0_quasar__["b" /* LocalStorage */].set(CONTENT_BACKUP_KEY, this.contentHTML);
      } else {
        __WEBPACK_IMPORTED_MODULE_0_quasar__["b" /* LocalStorage */].remove(CONTENT_BACKUP_KEY);
      }
      this.sentences = this.content.replace(/(\.+|:|;|\?|!)/g, '$1\n').split(/\n+\s*/).filter(function (n) {
        return n;
      });
      this.words = this.content.split(/\s+/).filter(function (n) {
        return n;
      });
    },
    processEditOperation: function processEditOperation(operation) {
      ...
      this.$nextTick(function () {
        _this6.contentHTML = operation.api.getFocusedElement().innerHTML;
      });
    },
      ...
      if (evt.key === 'F11') {
        ...
        if (evt.ctrlKey) {
          if (this.isElectron) {
            ...
            __WEBPACK_IMPORTED_MODULE_8_screenfull___default.a.toggle(__WEBPACK_IMPORTED_MODULE_8_screenfull___default.a.element || document.documentElement);
            this.isFullscreen = __WEBPACK_IMPORTED_MODULE_8_screenfull___default.a.isFullscreen;
          }
        }
      }
    },
    convertMdToHtml: function convertMdToHtml(md) {
      return mdToHtmlConverter.makeHtml(md);
    },
    convertHtmlToMd: function convertHtmlToMd(html) {
      return htmlToMdConverter.convert(html);
    },
    convertTxtToHtml: function convertTxtToHtml(txt) {
      return mdToHtmlConverter.makeHtml(txt);
    },
    convertHtmlToTxt: function convertHtmlToTxt(html) {
      return (html || '').replace(/<p>|<h\d+>|<li>/g, '\n\n').replace(/<br\s*\/*>/g, '\n').replace(/\n\n\n/g, '\n\n').replace(/<(?:.|\n)*?>/gm, '').trim();
    },
    showConfirmDialog: function showConfirmDialog(handlerFunc, title, message) {
      __WEBPACK_IMPORTED_MODULE_0_quasar__["a" /* Dialog */].create({
  ...
  watch: {
    contentHTML: function contentHTML(val) {
...
}( true ? __webpack_require__(106) : MediumEditor)));
...
var toMarkdown
var converters
var mdConverters = __webpack_require__(120)
var gfmConverters = __webpack_require__(121)
var HtmlParser = __webpack_require__(122)
var collapse = __webpack_require__(124)
...
function createHtmlParser () {
  ...
  if (typeof document === 'undefined') {
    var jsdom = __webpack_require__(123)
...
var blockElements = {};
__webpack_require__(126).forEach(function (name) {
...
} else if (("function" !== "undefined" && __webpack_require__(128) !== null) && (__webpack_require__(129) !== null)) {
  !(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
    return saveAs;
  }.call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("686d65ba", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("1def781e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("cb67dd74", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(30)("00120a9c", content, true);
...
// module
exports.push([module.i, "@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(145) + ") format(\"woff\");font-weight:400;font-style:normal}@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(146) + ") format(\"woff\");font-weight:400;font-style:italic}@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(147) + ") format(\"woff\");font-weight:700;font-style:normal}", ""]);
...
module.exports = __webpack_require__.p + "fonts/LibreBaskerville-Regular.2a9e9b1.woff";

/***/ }),
/* 146 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/LibreBaskerville-Italic.100476b.woff";

/***/ }),
/* 147 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/LibreBaskerville-Bold.7ebcbe1.woff";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('q-layout', {
    ...
    attrs: {
      "id": "toolbar",
      "isSaved": !_vm.isChanged,
      "wordCount": _vm.wordCount,
      "sentenceCount": _vm.sentenceCount
    },
    on: {
    ...
    on: {
      ...
      "open": function($event) {
        _vm.$refs.openFile.click()
      },
      "import": function($event) {
        _vm.$refs.importFile.click()
      },
      "save": function($event) {
        _vm.saveFile()
      },
    ...
    on: {
      "change": function($event) {
        _vm.openFile($event.target.files)
      }
    }
  }), _vm._v(" "), _c('input', {
    ref: "importFile",
    ...
    on: {
      "change": function($event) {
        _vm.importFile($event.target.files)
      }
    }
  }), _vm._v(" "), _c('vue-medium-editor', {
    class: _vm.opts,
    attrs: {
      "id": "editor",
      "custom-tag": "div",
      "text": _vm.contentHTML,
      "options": _vm.meOptions
    },
    on: {
      "edit": _vm.processEditOperation
    }
  }), _vm._v(" "), (!_vm.isElectron) ? _c('save-as-modal', {
    ref: "saveAsModal",
    attrs: {
      "id": "save-as-modal",
  ...
  }) : _vm._e(), _vm._v(" "), (!_vm.isElectron) ? _c('export-modal', {
    ref: "exportModal",
    attrs: {
      "id": "export-modal",
      "filename": this.filename || this.sentences[0]
    ...
    on: {
      "export": _vm.exportFile
    }
  }) : _vm._e(), _vm._v(" "), _c('settings-modal', {
    ref: "settingsModal",
    attrs: {
      "id": "settings-modal"
    },
    on: {
      "confirm": _vm.applySettings
    }
  }), _vm._v(" "), _c('about-modal', {
    ref: "aboutModal",
    attrs: {
      "id": "about-modal"
    }
