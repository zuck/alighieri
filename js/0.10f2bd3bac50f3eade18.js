webpackJsonp([0,1,2,3,4,5,6],Array(26).concat([
/* 26 */
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("1bbe3f77", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("299a8ac6", content, true);
...
// module
exports.push([module.i, "body{font-family:LibreBaskerville,serif;background-color:#fff;overflow-x:hidden}.layout-aside,.layout-header{box-shadow:none!important}.layout-padding{padding:2rem 2rem 1rem}.modal-buttons{padding:0 2rem 2rem;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}hr{border:none;border-top:1px solid #e1e2e3;margin-bottom:1rem}input{padding:8px;margin-bottom:.5rem;border:1px solid #888}#writer,input{display:block;width:100%;outline:none}#writer{box-sizing:border-box;min-width:256px;max-width:640px;min-height:5rem;margin:0 auto;padding:16px 32px;border:none;line-height:2;color:#333}#writer h1,#writer h2,#writer h3,#writer h4{margin:0 0 .5em;font-weight:inherit;line-height:1.2;color:#888}#writer h1+p,#writer h2+p,#writer h3+p,#writer h4+p{margin-top:1.414em}#writer h1{font-size:2.369em;color:#111}#writer h2{font-size:1.777em}#writer h3{font-size:1.333em}#writer h4{font-size:1em}#writer table{width:100%;margin-bottom:1rem;border-collapse:collapse}#writer table thead{text-align:left}#writer table td,#writer table th{padding:.5rem;border-bottom:1px solid #e1e2e3;vertical-align:top}#writer table thead td,#writer table thead th{border-color:#888}@media screen and (max-width:576px){#writer table tr{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}#writer table td,#writer table th{min-width:100%}#writer table td:not(:last-of-type),#writer table th:not(:last-of-type){border-bottom:none}}#writer pre{padding:1rem;border-radius:.25rem;overflow-x:auto;background-color:#e1e2e3}#writer pre code{background-color:transparent;white-space:pre-wrap}#writer code{padding:4px;white-space:nowrap;background-color:#e1e2e3}#writer blockquote{border-left-color:#e1e2e3}#writer blockquote :last-child{margin-bottom:0}@page{size:auto;margin:20mm 25mm 25mm}@media print{body{font-size:16px;background-color:transparent;padding:0!important;margin:0!important}.layout-aside,.layout-header{display:none}#writer,.layout-page,.layout-page-container{display:inline-block;width:100%!important;max-width:100%!important;padding:0!important;margin:0!important}}", ""]);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quasar__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_medium_editor__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_medium_editor_autolist__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_showdown__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_to_markdown__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_file_saver__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_screenfull__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_components_Toolbar__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_components_LeftMenu__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_components_SaveAsModal__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_components_ExportModal__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_components_SettingsModal__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_components_AboutModal__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_font_awesome_css_font_awesome_min_css__ = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_medium_editor_dist_css_medium_editor_min_css__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_medium_editor_dist_css_themes_beagle_min_css__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_assets_fonts_LibreBaskerville_stylesheet_css__ = __webpack_require__(95);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'writer',
  components: {
    QLayout: __WEBPACK_IMPORTED_MODULE_0_quasar__["i" /* QLayout */],
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_quasar__["p" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, this.contentHTML);
  ...
  methods: {
    resetFile: function resetFile() {
      __WEBPACK_IMPORTED_MODULE_0_quasar__["p" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, DEFAULT_CONTENT_HTML);
      ...
      if (files && files.length > 0) {
        ...
        reader.onload = function (evt) {
          try {
            ...
            __WEBPACK_IMPORTED_MODULE_0_quasar__["p" /* SessionStorage */].set(CONTENT_LAST_SAVED_KEY, _this.contentHTML);
          } catch (err) {
            reader.onerror(err);
          }
        };
    ...
    saveFile: function saveFile(fn) {
      ...
      if (this.filename) {
        ...
        if (this.isElectron) {
          __webpack_require__(4).writeFile(this.filename, fileContent, function (err) {
            if (err) throw err;
          });
        } else {
    ...
    exportFile: function exportFile(fn, ext) {
      ...
      if (fn) {
        ...
        if (fileType) {
          ...
          if (this.isElectron) {
            __webpack_require__(4).writeFile(filename, fileContent, function (err) {
              if (err) throw err;
            });
          } else {
    ...
    hasContentChanges: function hasContentChanges() {
      return this.contentHTML !== __WEBPACK_IMPORTED_MODULE_0_quasar__["p" /* SessionStorage */].get.item(CONTENT_LAST_SAVED_KEY);
    },
...
var toMarkdown
var converters
var mdConverters = __webpack_require__(72)
var gfmConverters = __webpack_require__(73)
var HtmlParser = __webpack_require__(74)
var collapse = __webpack_require__(76)
...
function createHtmlParser () {
  ...
  if (typeof document === 'undefined') {
    var jsdom = __webpack_require__(75)
...
var voidElements = __webpack_require__(77);
Object.keys(voidElements).forEach(function (name) {
  voidElements[name.toUpperCase()] = 1;
});

var blockElements = {};
__webpack_require__(78).forEach(function (name) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("686d65ba", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("1def781e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("cb67dd74", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(25)("00120a9c", content, true);
...
// module
exports.push([module.i, "@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(97) + ") format(\"woff\");font-weight:400;font-style:normal}@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(98) + ") format(\"woff\");font-weight:400;font-style:italic}@font-face{font-family:LibreBaskerville;src:url(" + __webpack_require__(99) + ") format(\"woff\");font-weight:700;font-style:normal}", ""]);
